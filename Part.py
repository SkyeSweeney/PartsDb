...
class Part():
    ...
    def __init__(self):
        ...
        self.fields.append( PartFieldInfo(1,  "Datasheet",     "Datasheet",      "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(2,  "Mfg",           "Mfg",            "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(3,  "MfgPartNo",     "Mfg Part #",     "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(4,  "MfgWebsite",    "Mfg Website",    "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(5,  "Vendor",        "Vendor",         "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(6,  "VendorPartNo",  "Vendor Part #",  "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(7,  "VendorWebsite", "Vendor Website", "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(8,  "Quantity",      "Quantity",       "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(9,  "Min",           "Min",            "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(10, "Name",          "Name",           "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(11, "Description",   "Description",    "TEXT",                True,     "*") )
        self.fields.append( PartFieldInfo(12, "Location",      "Location",       "TEXT",                True,     "*") )
